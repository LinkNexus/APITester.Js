...
export default class CreateCollectionForm extends AbstractCustomElement {
    Element() {
        return (
            <div id="default-modal" tabIndex={-1} aria-hidden="true" className="flex overflow-y-auto overflow-x-hidden items-center justify-center fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
