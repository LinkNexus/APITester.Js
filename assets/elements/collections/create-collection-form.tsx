    ...
    Element() {
        ...
        return (
            <div id="create-collection-modal" tabIndex={-1} aria-hidden="true"
                ...
                className="hidden overflow-y-auto overflow-x-hidden items-center justify-center fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                <div className="relative p-4 w-full max-w-2xl max-h-full">
                    <div className="relative bg-accent-2 rounded-lg shadow-sm border-primary border">
                        ...
                        <div className="p-4 md:p-5 space-y-4">
                            {error && (
                                <alert-message type="error" className={"mb-8"}>
                                    {error}
                                </alert-message>
                            )}
                            <form action={createCollection} className="max-w-full w-full flex flex-col gap-y-6">
